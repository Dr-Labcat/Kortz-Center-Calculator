...
//
// top-3, top-4, top-7, top-8, top-9, top-10, top-11 are the Krisp
// Collection cluster (purple) at the bottom of this floor.
export default [
    ...
    { id: 'top-3', x: 1070, y: 1533, label: 'Painting', type: 'painting', color: 'green' },
    { id: 'top-4', x: 1291, y: 1626, label: 'Painting', type: 'painting', color: 'green' },
    ...
    { id: 'top-7', x: 758, y: 1549, label: 'Plasma cutter case', type: 'cutter case', color: 'red' },
    { id: 'top-8', x: 946, y: 1698, label: 'Plasma cutter case', type: 'cutter case', color: 'red' },
    { id: 'top-9', x: 1153, y: 1696, label: 'Smash case', type: 'alarm case', color: 'yellow' },
    { id: 'top-10', x: 759, y: 1696, label: 'Smash case', type: 'alarm case', color: 'yellow' },
    { id: 'top-11', x: 655, y: 1552, label: 'Smash case', type: 'alarm case', color: 'yellow' },
